...
ModuleInfo "History: 1.01 Updated to 1.1.6"
ModuleInfo "History: 1.00 Release"
ModuleInfo "History: First release"

Import "LuaJIT-1.1.6/dynasm/*.h"

Import "LuaJIT-1.1.6/src/lapi.c"
Import "LuaJIT-1.1.6/src/lauxlib.c"
Import "LuaJIT-1.1.6/src/lbaselib.c"
Import "LuaJIT-1.1.6/src/lcoco.c"
Import "LuaJIT-1.1.6/src/lcode.c"
Import "LuaJIT-1.1.6/src/ldblib.c"
Import "LuaJIT-1.1.6/src/ldebug.c"
Import "LuaJIT-1.1.6/src/ldo.c"
Import "LuaJIT-1.1.6/src/ldump.c"
Import "LuaJIT-1.1.6/src/lfunc.c"
Import "LuaJIT-1.1.6/src/lgc.c"
Import "LuaJIT-1.1.6/src/linit.c"
Import "LuaJIT-1.1.6/src/liolib.c"
Import "LuaJIT-1.1.6/src/ljit_backend.c"
Import "LuaJIT-1.1.6/src/ljit_core.c"
Import "LuaJIT-1.1.6/src/ljit_dasm.c"
Import "LuaJIT-1.1.6/src/ljit_mem.c"
Import "LuaJIT-1.1.6/src/ljitlib.c"
Import "LuaJIT-1.1.6/src/llex.c"
Import "LuaJIT-1.1.6/src/lmathlib.c"
Import "LuaJIT-1.1.6/src/lmem.c"
Import "LuaJIT-1.1.6/src/loadlib.c"
Import "LuaJIT-1.1.6/src/lobject.c"
Import "LuaJIT-1.1.6/src/lopcodes.c"
Import "LuaJIT-1.1.6/src/loslib.c"
Import "LuaJIT-1.1.6/src/lparser.c"
Import "LuaJIT-1.1.6/src/lstate.c"
Import "LuaJIT-1.1.6/src/lstring.c"
Import "LuaJIT-1.1.6/src/lstrlib.c"
Import "LuaJIT-1.1.6/src/ltable.c"
Import "LuaJIT-1.1.6/src/ltablib.c"
Import "LuaJIT-1.1.6/src/ltm.c"
Import "LuaJIT-1.1.6/src/lua.c"
Import "LuaJIT-1.1.6/src/lundump.c"
Import "LuaJIT-1.1.6/src/lvm.c"
Import "LuaJIT-1.1.6/src/lzio.c"
Import "LuaJIT-1.1.6/src/print.c"
